...
export default function SuperStockApp() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-800 pb-16">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 flex shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
        
        {/* TOMBOL TELEGRAM (KIRI - BIRU) */}
        <a 
          href="https://t.me/+zrEOLwygGCBhZTQ1" 
          target="_blank" 
          rel="noopener noreferrer"
          className="flex-1 bg-[#0088cc] text-white p-3 flex items-center justify-center gap-2 hover:bg-[#0077b5] transition-colors border-r border-white/20"
        >
          ...
          <div className="flex flex-col leading-none text-left">
            <span className="text-[9px] opacity-80 uppercase font-bold">Gabung</span>
            <span className="font-bold text-sm">Grup RLA</span>
          </div>
        </a>

        {/* TOMBOL WHATSAPP (KANAN - HIJAU) */}
        <a 
          href="https://wa.me/6281299053961" 
          target="_blank" 
          rel="noopener noreferrer"
          className="flex-1 bg-[#25D366] text-white p-3 flex items-center justify-center gap-2 hover:bg-[#20bd5a] transition-colors"
        >
          ...
          <div className="flex flex-col leading-none text-left">
            <span className="text-[9px] opacity-80 uppercase font-bold">Chat Admin</span>
